...
import al.bruno.task.organiser.Indexes;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, String> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.CLOB.nullable(false).defaultValue(DSL.field("strftime('%Y-%m-%d %H:%M:%f','now')", SQLDataType.CLOB)), this, "");
    ...
    public UniqueKey<FlywaySchemaHistoryRecord> getPrimaryKey() {
        return Keys.FLYWAY_SCHEMA_HISTORY__;
    }
